...
describe('requestJudge', () => {
  const okResult: JudgeResult = {
    rounds: 2,
    panels: [
      { panelId: 'tuned', judges: [{ role: 'skeptic', score: 6, note: 'n' }], dimensions: [{ id: 'grounding', label: 'Grounding', score: 7 }], violations: [], synthesizedScore: 5.9, preGateScore: 6.1, gateTripped: false, borderline: false, rationale: 'r' },
    ],
  };
